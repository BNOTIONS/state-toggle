...
gutil.template(&#39;test &lt;%= name %&gt; &lt;%= file.path %&gt;&#39;, opt) // test todd /js/hi.js</code></pre>
<h3>log(msg...)</h3>
<p>Logs stuff. Already prefixed with [gulp] and all that. If you pass in multiple arguments it will join them by a space.</p>
<pre><code>values (files, module names, etc.) = magenta
numbers (times, counts, etc) = cyan</code></pre>
<h3>colors</h3>
...
var err = new gutil.PluginError(&#39;test&#39;, existingError, {showStack: true});</code></pre>
