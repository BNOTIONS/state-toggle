<!DOCTYPE html><html><head><link rel="stylesheet" href="galaxy/galaxy.css"><link rel="stylesheet" href="styles/docs.css"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/prism/0.0.1/prism.min.css"></head><body><h1>Libsass</h1>
...
<p><a href="https://travis-ci.org/sass/libsass"><img src="https://travis-ci.org/sass/libsass.png?branch=master" alt="Build Status"></a>
<a href="https://www.bountysource.com/trackers/283068-libsass?utm_source=283068&amp;utm_medium=shield&amp;utm_campaign=TRACKER_BADGE"><img src="https://www.bountysource.com/badge/tracker?tracker_id=283068" alt="Bountysource"></a>
<a href="https://coveralls.io/r/sass/libsass?branch=feature%2Ftest-travis-ci-3"><img src="https://img.shields.io/coveralls/sass/libsass.svg" alt="Coverage Status"></a></p>
...
<p>LibSass requires GCC 4.7+ or Clang/LLVM. If your OS is older, this version may not compile.</p>
<h2>About</h2>
...
<pre><code class="language-c">sass_context();        // string-in-string-out compilation
sass_file_context();   // file-based compilation
sass_folder_context(); // full-folder multi-file</code></pre>
...
<pre><code class="language-c">sass_new_context();
sass_new_file_context();
sass_new_folder_context();</code></pre>
...
<p>For a full list of implementations, checkout our
<a href="https://github.com/sass/libsass/wiki/Implementations">implementations wiki page</a></p>
<h2>About Sass</h2>
...
<p>Our MIT license is designed to be as simple, and liberal as possible.</p>
<p>sass2scss was originally written by Marcel Greter [@mgreter]
and he happily agreed to have it merged into the project.</p>
