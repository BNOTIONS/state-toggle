...
<pre><code class="language-shell">npm install grunt-contrib-watch --save-dev</code></pre>
<p>Once the plugin has been installed, it may be enabled inside your Gruntfile with this line of JavaScript:</p>
<pre><code class="language-js">grunt.loadNpmTasks(&#39;grunt-contrib-watch&#39;);</code></pre>
<h2>Watch task</h2>
...
<h4>options.livereloadOnError</h4>
...
<h3>Examples</h3>
<pre><code class="language-js">// Simple config to run jshint any time a file is added, changed or deleted
grunt.initConfig({
  watch: {
    files: [&#39;**/*&#39;],
    tasks: [&#39;jshint&#39;],
...
<pre><code class="language-js">// Advanced config. Run specific tasks when specific files are added, changed or deleted.
grunt.initConfig({
  watch: {
    gruntfile: {
      files: &#39;Gruntfile.js&#39;,
...
<h4>Using the <code>watch</code> event</h4>
...
<h5>Compiling Files As Needed</h5>
...
<pre><code class="language-js">var changedFiles = Object.create(null);
...
<h5>Enabling Live Reload in Your HTML</h5>
...
<pre><code class="language-html">&lt;script src=&quot;//localhost:35729/livereload.js&quot;&gt;&lt;/script&gt;</code></pre>
<p>Feel free to add this script to your template situation and toggle with some sort of <code>dev</code> flag.</p>
<h5>Using Live Reload with the Browser Extension</h5>
...
<h5>Using Connect Middleware</h5>
...
<h5>Rolling Your Own Live Reload</h5>
...
<pre><code class="language-js">// Create a live reload server instance
...
<h5>Live Reload with Preprocessors</h5>
...
<h3>FAQs</h3>
<h4>How do I fix the error <code>EMFILE: Too many opened files.</code>?</h4>
...
<h4>Can I use this with Grunt v0.3?</h4>
...
<h4>Why is the watch devouring all my memory/cpu?</h4>
...
<h4>Why spawn as child processes as a default?</h4>
