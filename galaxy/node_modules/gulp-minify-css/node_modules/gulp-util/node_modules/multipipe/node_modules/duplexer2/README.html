<!DOCTYPE html><html><head><link rel="stylesheet" href="galaxy/galaxy.css"><link rel="stylesheet" href="styles/docs.css"><link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/prism/0.0.1/prism.min.css"></head><body><h1>duplexer2 <a href="https://travis-ci.org/deoxxa/fork"><img src="https://travis-ci.org/deoxxa/duplexer2.png" alt="build status"></a></h1>
...
<pre><code class="language-javascript">duplexer2([options], writable, readable)</code></pre>
<pre><code class="language-javascript">var duplex = duplexer2(new stream.Writable(), new stream.Readable());</code></pre>
<p>Arguments</p>
<ul>
